...
class EndMap(MapFactory):  # Factory that creates Map and Objects when the game is over
...
class RandomMap(MapFactory):  # Factory that creates random Map and random Object (dependent on difficulty level)
    yaml_tag = "!random_map"
